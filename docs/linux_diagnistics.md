...
> Перемещение между снимками осуществляется с помощью следующих клавиш: `t` - следующий снимок; `T` - предыдущий снимок.

- После записи так же можно использовать `atopsar`, для анализа полученных логов
